    ...
    <div className="min-h-screen bg-background flex">
      ...
      <main className="flex-1 md:ml-64 p-4 md:p-8 flex flex-col items-center justify-center text-center">
        ...
        <div className="max-w-md">
          ...
          <h1 className="text-3xl font-bold font-display mb-3" data-testid="text-explorer-title">Data Explorer</h1>
          ...
          <div className="p-4 bg-card border border-border rounded-xl text-left font-mono text-sm overflow-x-auto">
            ...
            <div className="text-primary break-all">curl -X GET https://api.lumina.zone/v1/metrics \</div>
